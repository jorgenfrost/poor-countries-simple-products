...
read_npcms_blocks <- function() {
  ...
  # 1: Read files
  # 2: Prepare 2010-2011 files
  # 3: Prepare 2011-2012 files
  # 4: Prepare 2012-2013 files
  # 5: Prepare 2013-2014 files
  ...
  # At the moment, the data for each financial year (fx April-2012 to 
